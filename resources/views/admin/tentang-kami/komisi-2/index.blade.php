...
<div class="bg-white p-6 shadow rounded">
    ...
    <form action="{{ isset($editData) ? route('admin.komisi2.update', $editData->id) : route('admin.komisi2.store') }}"
        ...
        @if(isset($editData))
            <a href="{{ route('admin.komisi2.index') }}" class="bg-gray-400 text-white px-4 py-2 rounded shadow">Batal</a>
        @endif
    </form>
